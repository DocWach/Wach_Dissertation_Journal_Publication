...
public class GenZAC2toZAC2 extends CoupledModelImpl implements StateVariableBased{ 
	...
	public GenZAC2toZAC2(){
		this("GenZAC2toZAC2");
	}
	public GenZAC2toZAC2(String nm) {
		super(nm);
		make();
	}
	public void make(){

		genAC genAC = new genAC();
		addChildModel(genAC);
		ZAC2 ZAC2 = new ZAC2();
		addChildModel(ZAC2);
		addCoupling(genAC.outIoXA1,ZAC2.inIoXA1);
		addCoupling(ZAC2.outIoXA3,this.outIoXA3);
		addCoupling(ZAC2.outIoXA4,this.outIoXA4);
		addCoupling(genAC.outIoXA2,ZAC2.inIoXA2);
		addCoupling(ZAC2.outIoXC1,this.outIoXC1);
		addCoupling(genAC.outIoXC1,ZAC2.inIoXC1);
	...
	public static void main(String[] args){
		...
		GenZAC2toZAC2 model = new GenZAC2toZAC2();
		model.options = options;
		if(options.isDisableViewer()){ // Command Line output only
			Simulation sim = new com.ms4systems.devs.core.simulation.impl.SimulationImpl("GenZAC2toZAC2 Simulation",model,options);
