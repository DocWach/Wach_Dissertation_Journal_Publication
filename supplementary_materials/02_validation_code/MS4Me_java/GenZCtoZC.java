...
public class GenZCtoZC extends CoupledModelImpl implements StateVariableBased{ 
	...
	public void make(){
		...
		ZG ZG = new ZG();
		addChildModel(ZG);
		addCoupling(genG.outIoXG1,ZG.inIoXG1);
		addCoupling(ZG.outIoXG2,this.outIoXG2);
	...
	public static void main(String[] args){
		...
		GenZCtoZC model = new GenZCtoZC();
		model.options = options;
		if(options.isDisableViewer()){ // Command Line output only
			Simulation sim = new com.ms4systems.devs.core.simulation.impl.SimulationImpl("GenZCtoZC Simulation",model,options);
