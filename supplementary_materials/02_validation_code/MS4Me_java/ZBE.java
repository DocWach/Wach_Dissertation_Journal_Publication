...
DNL
platform:/resource/DissertationModels/src/Models/dnl/ZBE.dnl
-408455442
 Do not remove or modify this comment!  It is required for file identification! */
package Models.java;
...
public class ZBE extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    public ZBE(String name) {
        this(name, null);
    }

    public ZBE(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("ZBE Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = ZBE.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                ZBE.class.getResource(".").toString());
        }
