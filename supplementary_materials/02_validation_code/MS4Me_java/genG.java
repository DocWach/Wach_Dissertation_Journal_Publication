...
DNL
platform:/resource/DissertationModels/src/Models/dnl/genG.dnl
942067872
 Do not remove or modify this comment!  It is required for file identification! */
package Models.java;
...
public class genG extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    public genG(String name) {
        this(name, null);
    }

    public genG(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("genG Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = genG.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                genG.class.getResource(".").toString());
        }
