// For homomorphism proof between ZCG and ZBC
...
public class HomZBCZCG {
	...
	public static void main(String[] args) {
		...
		if (options.isDisableViewer()) { // Command line output only
			Simulation simA = new SimulationImpl("ZCG Simulation", ZCG, options);
			...
			int i = 0; // starts in initial state and time equals zero
				...
				String hZBCZCG = h.get(bState).toString();
