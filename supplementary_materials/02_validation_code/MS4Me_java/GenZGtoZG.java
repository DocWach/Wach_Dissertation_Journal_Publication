...
public class GenZGtoZG extends CoupledModelImpl implements StateVariableBased{ 
	...
	public static void main(String[] args){
		...
		GenZGtoZG model = new GenZGtoZG();
		model.options = options;
		if(options.isDisableViewer()){ // Command Line output only
			Simulation sim = new com.ms4systems.devs.core.simulation.impl.SimulationImpl("GenZGtoZG Simulation",model,options);
