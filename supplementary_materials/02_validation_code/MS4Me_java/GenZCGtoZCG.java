...
public class GenZCGtoZCG extends CoupledModelImpl implements StateVariableBased{ 
	private static final long serialVersionUID = 1L;
	protected SimulationOptionsImpl options = new SimulationOptionsImpl();
	
		public final Port<? extends Serializable> outIoXC1= addOutputPort("outIoXC1",Serializable.class);
		public final Port<? extends Serializable> outIoXG2= addOutputPort("outIoXG2",Serializable.class);
	public GenZCGtoZCG(){
		this("GenZCGtoZCG");
	}
	public GenZCGtoZCG(String nm) {
		super(nm);
		make();
	}
	public void make(){

		genCG genCG = new genCG();
		addChildModel(genCG);
		ZCG ZCG = new ZCG();
		addChildModel(ZCG);
		addCoupling(ZCG.outIoXC1,this.outIoXC1);
		addCoupling(genCG.outIoXC1,ZCG.inIoXC1);
		addCoupling(ZCG.outIoXG2,this.outIoXG2);
		addCoupling(genCG.outIoXG1,ZCG.inIoXG1);
	...
	public static void main(String[] args){
		...
		GenZCGtoZCG model = new GenZCGtoZCG();
		model.options = options;
		if(options.isDisableViewer()){ // Command Line output only
			Simulation sim = new com.ms4systems.devs.core.simulation.impl.SimulationImpl("GenZCGtoZCG Simulation",model,options);
