...
public class ZA2 extends CoupledModelImpl implements StateVariableBased{ 
	...
	public static void main(String[] args){
		...
		if(options.isDisableViewer()){ // Command Line output only
			Simulation sim = new com.ms4systems.devs.core.simulation.impl.SimulationImpl("ZA2 Simulation",model,options);
