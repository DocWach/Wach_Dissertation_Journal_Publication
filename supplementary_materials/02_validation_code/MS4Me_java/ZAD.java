...
DNL
platform:/resource/DissertationModels/src/Models/dnl/ZAD.dnl
1528806220
 Do not remove or modify this comment!  It is required for file identification! */
package Models.java;
...
public class ZAD extends AtomicModelImpl implements PhaseBased,
    StateVariableBased {
    ...
    // Output ports
    //ID:OUTP:0
    public final Port<Serializable> outIoXA6 =
        addOutputPort("outIoXA6", Serializable.class);

    //ENDID
    //ID:OUTP:1
    public final Port<Serializable> outIoXA5 =
        addOutputPort("outIoXA5", Serializable.class);
    ...
    public ZAD(String name, Simulator simulator) {
    ...
    public static void main(String[] args) {
        ...
        if (options.isDisableViewer()) { // Command line output only
            Simulation sim =
                new SimulationImpl("ZAD Simulation", model, options);
    ...
    protected static File getModelsDirectory() {
        ...
        File dir;
        try {
            dirUri = ZAD.class.getResource(".").toURI();
            dir = new File(dirUri);
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new RuntimeException(
                "Could not find Models directory. Invalid model URL: " +
                ZAD.class.getResource(".").toString());
        }
    ...
    public String[] getPhaseNames() {
        return new String[] { "SAD1", "trans12", "SAD2", "trans21" };
    }
}
