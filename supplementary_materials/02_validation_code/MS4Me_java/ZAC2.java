...
public class ZAC2 extends CoupledModelImpl implements StateVariableBased{ 
	...
	public void make(){
		...
		ZAE ZAE = new ZAE();
		addChildModel(ZAE);
		addCoupling(ZAD.outIoXA5,ZAE.inIoXA5);
		addCoupling(this.inIoXA1,ZAD.inIoXA1);
		addCoupling(ZAD.outIoXA6,ZAE.inIoXA6);
		addCoupling(ZAE.outIoXA3,this.outIoXA3);
		addCoupling(ZAE.outIoXA4,this.outIoXA4);
		addCoupling(this.inIoXA2,ZAD.inIoXA2);
	...
	public static void main(String[] args){
		...
		if(options.isDisableViewer()){ // Command Line output only
			Simulation sim = new com.ms4systems.devs.core.simulation.impl.SimulationImpl("ZAC2 Simulation",model,options);
